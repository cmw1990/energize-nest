...
-- care_group_events policies
DROP POLICY IF EXISTS "allow_all_care_group_events" ON care_group_events;

-- care_group_tasks policies
DROP POLICY IF EXISTS "allow_all_care_group_tasks" ON care_group_tasks;

-- care_group_notes policies
DROP POLICY IF EXISTS "allow_all_care_group_notes" ON care_group_notes;

-- care_group_resources policies
DROP POLICY IF EXISTS "allow_all_care_group_resources" ON care_group_resources;

-- care_group_volunteers policies
DROP POLICY IF EXISTS "allow_all_care_group_volunteers" ON care_group_volunteers;
