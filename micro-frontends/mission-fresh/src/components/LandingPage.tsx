        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              <Link 
                to="/mission-fresh/app/nrt-directory" 
                className="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-500 font-medium"
              >
                NRT Directory
              </Link>
              <Link 
                to="/mission-fresh/app/alternative-products" 
                className="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-500 font-medium"
              >
                Smokeless Alternatives
              </Link>
              <Link 
                to="/mission-fresh/app/guides" 
                className="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-500 font-medium"
              >
                Quitting Guides
              </Link>
              <Link 
                to="/mission-fresh/app/community" 
                className="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-500 font-medium"
              >
                Community
              </Link>
            ...
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  ...
                  onClick={() => navigate('/mission-fresh/app/community')}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
                ...
                <Button 
                  onClick={() => window.location.href = '/webapp/nrt-directory'}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
                ...
                <Button 
                  onClick={() => window.location.href = '/webapp/alternative-products'}
                  className="w-full bg-green-600 hover:bg-green-700 text-white"
                >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
                ...
                <Button 
                  onClick={() => window.location.href = '/webapp/quitting-guides'}
                  className="w-full bg-green-600 hover:bg-green-700 text-white"
                >
                  Explore Guides
                </Button>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-green-100 dark:border-green-800 hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  <Link to="/webapp/nrt-directory" className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-green-100 dark:border-green-800 hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  <Link to="/webapp/alternative-products" className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Explore Alternatives
                  </Link>
                </div>
              </div>
