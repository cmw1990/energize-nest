...
export const MissionFreshLayout: React.FC<MissionFreshLayoutProps> = ({ children, session }) => {
  ...
  const navigation = [
    ...
    { name: 'Track Progress', href: '/app/progress', icon: BarChart },
    { name: 'Log Consumption', href: '/app/consumption-logger', icon: TimerReset },
    { name: 'NRT Directory', href: '/app/nrt-directory', icon: Cigarette },
    { name: 'Alternative Products', href: '/app/alternative-products', icon: Leaf },
    { name: 'Guides & Resources', href: '/app/guides', icon: BookOpen },
    { name: 'Web Tools', href: '/app/tools', icon: Compass },
    { name: 'Community', href: '/app/community', icon: Ruler },
    { name: 'Settings', href: '/app/settings', icon: SettingsIcon },
    { name: 'Tasks', href: '/app/tasks', icon: Calendar },
  ];
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between h-16 px-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 md:hidden">
        ...
        <Link to="/" className="flex items-center gap-1 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
