        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link
                to="/care-connector/webapp/caregiver-connector"
              ...
              <Link
                to="/care-connector/webapp/pal-connector"
                className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400"
              >
                Find Companions
              </Link>
              <Link
                to="/care-connector/webapp/facilities-comparer"
                className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400"
              >
                Care Facilities
              </Link>
              <Link
                to="/care-connector/webapp/product-comparer"
                className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400"
              >
                Care Products
              </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-12">
            ...
            <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
              ...
              <Link to="/care-connector/webapp/caregiver-connector">
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li>
                  <Link to="/care-connector/webapp/marketplace" className="text-base text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                    Care Guides
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li>
                  <Link to="/care-connector/webapp/facilities-comparer" className="text-base text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                    Care Facilities
                  </Link>
                </li>
              </ul>
