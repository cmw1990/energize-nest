-- =====================================================
-- SUPER SIMPLIFIED RLS POLICY SOLUTION FOR CARE CONNECTOR
-- These are the absolute simplest policies possible while still
-- keeping RLS enabled - no column references to avoid errors
-- =====================================================
