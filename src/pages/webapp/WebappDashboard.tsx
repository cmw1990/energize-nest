...
export const WebappDashboard = () => {
  const [quickTools, setQuickTools] = useState<QuickTool[]>([
    // Focus Tools
    { id: '1', name: 'White Noise', icon: Volume2, href: '/webapp/focus/white-noise', category: 'Focus', pinned: true },
    { id: '2', name: 'Distraction Blocker', icon: Shield, href: '/webapp/focus/blocker', category: 'Focus', pinned: true },
    { id: '3', name: 'Focus Timer', icon: Timer, href: '/webapp/focus/timer', category: 'Focus', pinned: true },
    { id: '4', name: 'Brain Games', icon: Gamepad, href: '/webapp/cognitive/games', category: 'Cognitive', pinned: false },
    
    // Mental Health Tools
    { id: '5', name: 'Meditation', icon: Brain, href: '/webapp/mental-health/meditation', category: 'Mental Health', pinned: true },
    { id: '6', name: 'Breathing', icon: Wind, href: '/webapp/mental-health/breathing', category: 'Mental Health', pinned: true },
    { id: '7', name: 'Mood Journal', icon: BookOpen, href: '/webapp/mental-health/journal', category: 'Mental Health', pinned: false },
    { id: '8', name: 'Calming Sounds', icon: Music, href: '/webapp/mental-health/sounds', category: 'Mental Health', pinned: false },
    
    // Physical Tools
    { id: '9', name: 'Step Counter', icon: Footprints, href: '/webapp/exercise/steps', category: 'Exercise', pinned: true },
    { id: '10', name: 'Desk Exercises', icon: Dumbbell, href: '/webapp/office/desk-exercises', category: 'Exercise', pinned: false },
    { id: '11', name: 'Eye Care', icon: Eye, href: '/webapp/office/eye-care', category: 'Exercise', pinned: true },
    { id: '12', name: 'Break Timer', icon: Clock, href: '/webapp/office/break-timer', category: 'Exercise', pinned: false },
  ]);
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Your wellness toolkit</CardDescription>
            </div>
        ...
        <CardContent>
          <Tabs defaultValue="pinned" className="space-y-4">
            ...
            <TabsContent value="pinned">
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4">
                  {quickTools.filter(tool => tool.pinned).map((tool) => (
                    <Link to={tool.href} key={tool.id}>
                      <Card className="inline-block w-[150px] hover:bg-accent cursor-pointer">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <TabsContent value="focus">
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4">
                  {quickTools.filter(tool => tool.category === 'Focus').map((tool) => (
                    <Link to={tool.href} key={tool.id}>
                      <Card className="inline-block w-[150px] hover:bg-accent cursor-pointer">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                          <tool.icon className="h-4 w-4 text-muted-foreground" />
            ...
            <TabsContent value="mental">
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4">
                  {quickTools.filter(tool => tool.category === 'Mental Health').map((tool) => (
                    <Link to={tool.href} key={tool.id}>
                      <Card className="inline-block w-[150px] hover:bg-accent cursor-pointer">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                          <tool.icon className="h-4 w-4 text-muted-foreground" />
            ...
            <TabsContent value="physical">
              <ScrollArea className="w-full whitespace-nowrap">
                <div className="flex space-x-4">
                  {quickTools.filter(tool => tool.category === 'Exercise').map((tool) => (
                    <Link to={tool.href} key={tool.id}>
                      <Card className="inline-block w-[150px] hover:bg-accent cursor-pointer">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                          <tool.icon className="h-4 w-4 text-muted-foreground" />
